...
Build and testing environment in homelab.
...
Setup a build/test qube named "homelab-tofu", dedicated to contributing to
...
```sh
sudo qubesctl top.enable homelab-tofu
sudo qubesctl --targets=tpl-homelab-tofu,dvm-homelab-tofu,homelab-tofu state.apply
sudo qubesctl top.disable homelab-tofu
